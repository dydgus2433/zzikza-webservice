...
<%--                             	<span class="pre">${product.price}</span><span class="now"><strong>${product.productSalePrice}</strong>원</span> --%>
								...
								<c:if test="${not empty  product.productSalePrice}"><span class="pre">${product.price}</span><span class="now"><strong>${product.productSalePrice}</strong>원</span></c:if>
								<c:if test="${empty  product.productSalePrice}"><span class="now"><strong><fmt:formatNumber type="number">${product.price}</fmt:formatNumber></strong>원</span></c:if>
            ...
            <div class="contentsView"  style="white-space: pre-wrap;"><c:out value="${product.productDescription }"></c:out></div>
