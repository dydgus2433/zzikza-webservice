	...
	<script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
		...
		<div class="left_content_area">
			...
			<div class="box_area full">
					<h3 class="sub_stit">사업자정보 수정</h3>
				<form id="infoFrm" action="${contextPath}/api/updateInfoBusiness" method="post">
				<div class="box_area full">
				...
				<div class="box_area full">
					<h3 class="sub_stit">사업자 번호</h3>
					<input type="text" id="bsnsNo" name="bsnsNo" class="form_goods" placeholder="사업자 번호를 입력해 주세요." value="${info.bsnsNo }">
				</div>
				<div class="box_area full">
					<h3 class="sub_stit">사업자 등록증</h3>
					<input type="file" name="bsnsLicFile" id="bsnsLicFile" class="form_goods" placeholder="사업자 등록증 파일을 입력해 주세요." value="${info.bsnsLicFile }">
				 	<div class="btn_area">
...
<script src="${contextPath}/resources/js/info/infoBusiness.js"></script>
